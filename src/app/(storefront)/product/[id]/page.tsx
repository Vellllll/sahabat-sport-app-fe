  ...
  if (!productData) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8FAFC] p-4">
        ...
        <Link href="/" className="bg-brand text-white px-6 py-3 rounded-xl font-bold text-xs tracking-widest uppercase shadow-md hover:bg-brand-hover transition-all">
          Kembali ke Toko
        </Link>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] py-12 px-4 md:px-8">
      <div className="max-w-[1100px] mx-auto">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-xs font-bold text-slate-400 hover:text-brand transition-colors mb-8 tracking-widest uppercase"
        >
