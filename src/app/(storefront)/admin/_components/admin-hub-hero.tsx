    ...
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-black tracking-tight text-slate-900 uppercase flex items-center gap-2">
          <LayoutDashboard className="h-6 w-6 text-brand" /> Hub Administrasi
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {canManageCategories && (
            <Link
              ...
              className="group p-5 bg-white border border-slate-100 rounded-[24px] shadow-[0_4px_20px_rgba(0,0,0,0.01)] flex items-center justify-between hover:border-brand/30 hover:shadow-md transition-all cursor-pointer"
            >
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 bg-blue-50 text-brand rounded-xl flex items-center justify-center">
          ...
          {canManageProducts && (
            <Link href="/admin/units" className="group p-5 bg-white border border-slate-100 rounded-[24px] shadow-[0_4px_20px_rgba(0,0,0,0.01)] flex items-center justify-between hover:border-brand/30 hover:shadow-md transition-all cursor-pointer">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 bg-blue-50 text-brand rounded-xl flex items-center justify-center">
