    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-slate-100">
        <div className="flex items-center gap-3 bg-slate-50 px-4 py-2 rounded-xl border border-slate-100">
          ...
          <select value={currentLimit} onChange={(e) => updateUrl({ limit: e.target.value, page: 1 })} className="bg-transparent text-xs font-black text-brand outline-none cursor-pointer">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="px-4 py-1.5 rounded-full bg-white border border-slate-100 shadow-sm">
            <span className="text-[10px] font-black text-brand tracking-widest">{currentPage} / {totalPages}</span>
          </div>
