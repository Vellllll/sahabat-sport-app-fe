        ...
        <form action={formAction} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="w-full rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3.5 text-sm font-semibold text-slate-700 outline-none focus:bg-white focus:border-brand transition-all h-11 focus-visible:ring-0 focus-visible:ring-offset-0"
            />
            {state.errors?.name && (
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-full rounded-2xl border border-slate-100 bg-slate-50 pl-10 pr-4 py-3.5 text-sm font-bold text-slate-700 outline-none focus:bg-white focus:border-brand h-11 focus-visible:ring-0 focus-visible:ring-offset-0"
                />
              </div>
              {state.errors?.price && (
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="w-full rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3.5 text-sm font-bold text-slate-700 outline-none focus:bg-white focus:border-brand h-11 focus-visible:ring-0 focus-visible:ring-offset-0"
              />
              {state.errors?.stock && (
          ...
          <div className="pt-4">
            <button
              type="submit"
              disabled={isPending}
              className="flex w-full items-center justify-center gap-3 rounded-2xl bg-brand py-4 text-xs font-black tracking-[0.15em] text-white shadow-lg shadow-brand/10 hover:bg-brand-hover transition-all disabled:opacity-60 uppercase cursor-pointer h-12"
            >
