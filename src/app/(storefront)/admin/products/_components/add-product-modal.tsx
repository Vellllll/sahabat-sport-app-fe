    ...
    <>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="bg-brand text-white p-3 rounded-2xl font-bold text-xs tracking-widest hover:bg-brand-hover shadow-lg shadow-brand/20 transition-all flex items-center gap-2 cursor-pointer"
        >
          <Plus />
        </button>
      </div>
            ...
            <form ref={formRef} action={formAction} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-transparent focus:bg-white focus:border-brand rounded-xl outline-none transition-all font-medium text-slate-700" 
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select 
                    ...
                    required 
                    disabled={isPending}
                    className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-transparent focus:bg-white focus:border-brand rounded-xl outline-none appearance-none font-medium text-slate-700 cursor-pointer"
                  >
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="w-10 h-5 bg-slate-200 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-brand"></div>
                </label>
              </div>
              ...
              <button 
                type="submit" 
                disabled={isPending} 
                className="w-full bg-brand text-white py-4 rounded-2xl font-bold text-xs tracking-widest shadow-lg shadow-brand/20 hover:bg-brand-hover transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
