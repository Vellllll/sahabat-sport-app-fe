      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900 tracking-tight break-words">{category.name}</h1>
              <p className="text-slate-400 text-[10px] font-bold mt-1">ID: {category.id}</p>
            </div>
          </div>

          {category.description && (
            <div className="mb-8">
              <h2 className="text-[11px] font-bold text-slate-400 mb-2">Deskripsi</h2>
          ...
          <div className="mb-8">
            <h2 className="text-[11px] font-bold text-slate-400 mb-3 flex items-center gap-2">
          ...
          <div className="flex items-center gap-3 pt-6 border-t border-slate-50">
            <Link
              ...
              className="flex-1 py-3.5 rounded-2xl font-bold text-xs bg-brand text-white text-center hover:bg-brand-hover transition-all flex items-center justify-center gap-2"
            >
