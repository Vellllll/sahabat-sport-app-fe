  ...
  return (
    <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between gap-4 relative">
      ...
      <div className="flex items-center gap-3">
        <div className="h-8 w-8 bg-blue-50 text-brand rounded-xl flex items-center justify-center shadow-inner">
      ...
      <div className="flex items-center bg-slate-50 border border-slate-100 rounded-xl px-4 py-2">
        ...
        <select
          ...
          className="bg-transparent text-xs font-black text-brand outline-none cursor-pointer appearance-none pr-2"
        >
          {yearsOptions.map((yr) => (
