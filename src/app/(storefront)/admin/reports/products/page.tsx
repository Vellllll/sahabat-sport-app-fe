    ...
    <main className="min-h-screen bg-[#F8FAFC] py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto space-y-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200/60">
          <div className="space-y-1.5">
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900 uppercase flex items-center gap-2.5">
              <Package className="h-8 w-8 text-brand" /> Laporan Penjualan Produk
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-[28px] border border-slate-100 shadow-sm space-y-4 border-l-4 border-l-brand">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] font-black text-brand bg-blue-50 inline-block px-2.5 py-1 rounded-md uppercase tracking-wide">
                        ...
                        {products.length === 0 ? (
                          ...
                          products.map((item) => (
                            <tr key={item.product_id} className="hover:bg-slate-50/30 transition-colors group">
                              ...
                              <td className="text-sm sm:text-base font-black text-slate-800 py-4 px-4 uppercase group-hover:text-brand transition-colors">
                                {item.product_name}
                              </td>
