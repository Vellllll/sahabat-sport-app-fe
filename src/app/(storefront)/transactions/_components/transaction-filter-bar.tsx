    ...
    <form onSubmit={handleApplyFilter} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end text-slate-700 relative">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-11 bg-slate-50 border border-slate-100 rounded-xl pl-10 pr-4 text-xs font-bold outline-none focus:bg-white focus:border-brand focus:ring-4 focus:ring-brand/5 transition-all text-slate-800"
          />
        </div>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="w-full h-11 bg-slate-50 border border-slate-100 rounded-xl px-4 text-xs font-bold outline-none focus:bg-white focus:border-brand transition-all text-slate-600 cursor-pointer"
        />
      </div>
      ...
      <div className="space-y-1.5 flex flex-col">
        ...
        <Select value={status} onValueChange={setStatus}>
          <SelectTrigger className="w-full h-11 bg-slate-50 border-slate-100 rounded-xl px-4 text-xs font-bold text-slate-700 shadow-none focus:bg-white focus:border-brand focus:ring-4 focus:ring-brand/5 transition-all cursor-pointer">
