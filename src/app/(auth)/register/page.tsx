      ...
      <div className="hidden md:flex md:w-5/12 bg-slate-950 p-12 flex-col justify-between relative overflow-hidden text-white select-none">
        ...
        <div className="space-y-6 z-10 max-w-sm my-auto">
          ...
          <h2 className="text-4xl font-black tracking-tight leading-[1.15] text-slate-50">
            Satu Akun Untuk <span className="text-brand">Seluruh</span> Kebutuhan Olahragamu.
          </h2>
        ...
        <div className="w-full max-w-xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="h-13 bg-slate-50 md:bg-slate-50/70 border border-slate-100/70 focus:border-brand rounded-2xl px-5 text-sm font-bold text-slate-700 outline-none focus:bg-white focus:ring-4 focus:ring-brand/5 transition-all w-full"
                />
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <Link href="/login" className="text-xs font-black uppercase tracking-widest text-brand hover:text-brand-hover flex items-center gap-1.5 transition-all hover:gap-2">
