        ...
        <form onSubmit={handleApplyFilter} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end text-slate-700">
            ...
            <div className="space-y-1.5">
                ...
                <select
                    ...
                    className="w-full h-11 bg-slate-50 border border-slate-100 rounded-xl px-4 text-xs font-bold outline-none focus:bg-white"
                >
                    <option value="ALL">SEMUA STATUS</option>
                    <option value="READY">SIAP DIAMBIL</option>
                    <option value="NOT_READY">SEDANG DIPROSES</option>
                </select>
            </div>
