  ...
  if (!detail) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center">
        ...
        <Link href="/transactions" className="text-sm font-black text-[#165dfc] uppercase tracking-widest mt-2 hover:underline">
          Kembali ke Riwayat
        </Link>
      </div>
    );
      ...
      <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-4 flex-1">
              <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900 flex items-center gap-2.5">
                <Receipt className="h-7 w-7 text-[#165dfc]" /> #{detail.number}
              </h1>
            ...
            <div className="w-full md:w-auto shrink-0 flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
              ...
              {detail.is_rejected ? (
                ...
                <Link
                  href={`/checkout/${id}`}
                  className="inline-flex items-center justify-center gap-2 h-12 px-6 bg-[#165dfc] hover:bg-[#124ecb] text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all shadow-lg shadow-[#165dfc]/10 active:scale-[0.99] text-center"
                >
        ...
        <div className="pt-8 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-50/40 p-6 rounded-2xl border border-dashed">
          ...
          <div className="w-full sm:w-auto text-right space-y-1">
            ...
            <p className="text-2xl sm:text-4xl font-black text-[#165dfc] font-mono tracking-tight">
