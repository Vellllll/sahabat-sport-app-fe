    ...
    <AlertDialog>
      ...
      <AlertDialogTrigger asChild>
        <button
          type="button"
          disabled={isPending}
          className="inline-flex items-center justify-center gap-2 h-11 px-5 bg-[#165dfc] hover:bg-[#124ecb] text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all shadow-md shadow-[#165dfc]/10 active:scale-[0.99] cursor-pointer disabled:cursor-not-allowed w-full md:w-auto"
        >
          {isPending ? (
            <>
      ...
      <AlertDialogContent className="rounded-[28px] max-w-sm border-none bg-white p-6 gap-5 shadow-[0_30px_70px_rgba(0,0,0,0.08)]">
        <AlertDialogHeader className="space-y-2 text-left">
          <AlertDialogTitle className="text-base font-black text-slate-950 uppercase tracking-tight flex items-center gap-2">
            <PackageCheck className="h-4 w-4 text-[#165dfc]" /> Konfirmasi Penyiapan
          </AlertDialogTitle>
        ...
        <AlertDialogFooter className="flex flex-row items-center gap-2 pt-1">
          ...
          <AlertDialogAction
            ...
            className="flex-1 h-11 bg-[#165dfc] hover:bg-[#124ecb] text-white font-black text-xs uppercase tracking-widest rounded-xl transition-all cursor-pointer shadow-md shadow-[#165dfc]/5 border-none"
          >
            Ya, Kirim
          </AlertDialogAction>
        </AlertDialogFooter>
