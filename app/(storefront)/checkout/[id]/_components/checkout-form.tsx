        ...
        <Popover open={openPopover} onOpenChange={setOpenPopover}>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              role="combobox"
              className="w-full h-12 bg-slate-50 hover:bg-slate-50 border-slate-100 justify-between font-bold text-xs px-4 rounded-xl text-left text-slate-700 focus:ring-4 focus:ring-[#165dfc]/5 focus:border-[#165dfc] transition-all"
            >
                ...
                <CommandGroup>
                  {bankAccounts.map((bank) => (
                    ...
                    >
                      ...
                      <Check className={cn("h-4 w-4 text-[#165dfc]", selectedAccountNumber === bank.number ? "opacity-100" : "opacity-0")} />
                    </CommandItem>
                  ))}
                </CommandGroup>
              </CommandList>
