        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200/60">
          <div className="space-y-1.5">
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900 uppercase flex items-center gap-2.5">
              <LayoutDashboard className="h-8 w-8 text-[#165dfc]" /> Admin Dashboard
            </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="bg-white p-5 rounded-[24px] border border-slate-100 shadow-sm space-y-3.5">
            <div className="flex items-center justify-between">
              ...
              <div className="h-8 w-8 rounded-xl bg-blue-50 text-[#165dfc] flex items-center justify-center shadow-inner">
                ...
                {(top_products || []).length === 0 ? (
                  ...
                  (top_products || []).map((prod, index) => (
                    <tr key={prod.id} className="hover:bg-slate-50/30 transition-colors group">
                      ...
                      {/* Nama Produk */}
                      <td className="text-xs sm:text-sm font-black text-slate-800 py-4 px-4 uppercase group-hover:text-[#165dfc] transition-colors">
                        {prod.name}
                      </td>
