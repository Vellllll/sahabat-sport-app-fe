        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200/60">
          <div className="space-y-1.5">
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900 uppercase flex items-center gap-2.5">
              <BarChart3 className="h-8 w-8 text-[#165dfc]" /> Ikhtisar Pendapatan & Transaksi
            </h1>
          ...
          <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm space-y-6">
            <div className="space-y-1">
              <h2 className="text-sm font-black text-slate-800 uppercase tracking-wider flex items-center gap-2">
                <Layers className="h-4 w-4 text-[#165dfc]" /> Komposisi Arus Operasional
              </h2>
                ...
                <tbody className="divide-y divide-slate-100">
                  {monthly_trends.map((trend, index) => (
                    <tr key={index} className="hover:bg-slate-50/40 transition-colors">
                      ...
                      <td className="text-sm font-black text-[#165dfc] text-right font-mono px-5">
