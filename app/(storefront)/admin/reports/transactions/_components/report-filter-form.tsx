      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 flex-1">
        ...
        <div className="flex flex-col space-y-1 flex-1">
          <input
            ...
            className="px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-xs font-bold text-slate-700 outline-none focus:bg-white focus:border-[#165dfc] transition-all cursor-pointer w-full"
          />
        </div>
