        ...
        <form action={formAction} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input type="text" name="name" defaultValue={unit.name} required disabled={isPending} className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-transparent focus:bg-white focus:border-[#165dfc] rounded-xl outline-none transition-all font-medium text-slate-700" />
            </div>
          ...
          <div className="space-y-2">
            ...
            <input type="number" name="quantity" defaultValue={unit.quantity} required disabled={isPending} min="1" className="w-full px-4 py-3 bg-slate-50 border border-transparent focus:bg-white focus:border-[#165dfc] rounded-xl outline-none transition-all font-medium text-slate-700" />
            {state.errors?.quantity && <p className="text-red-500 text-[10px] font-bold ml-1">{state.errors.quantity[0]}</p>}
          </div>

          <button type="submit" disabled={isPending} className="w-full bg-[#165dfc] text-white py-4 rounded-xl font-bold text-xs tracking-widest hover:bg-[#124ecb] transition-all disabled:opacity-50 flex items-center justify-center gap-2 uppercase">
