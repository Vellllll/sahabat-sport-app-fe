      ...
      <div className="w-full max-w-[540px]">
        ...
        <div className="bg-white rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 p-8">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-14 h-14 rounded-2xl bg-[#165dfc]/5 flex items-center justify-center text-[#165dfc] shrink-0">
          ...
          <div className="flex items-center gap-3 pt-6 border-t border-slate-50">
            <Link
              ...
              className="flex-1 py-3.5 rounded-2xl font-bold text-xs tracking-widest bg-[#165dfc] text-white text-center shadow-lg shadow-[#165dfc]/20 hover:bg-[#124ecb] transition-all uppercase flex items-center justify-center gap-2"
            >
