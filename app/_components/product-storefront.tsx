// app/_components/product-storefront.tsx
'use client';
...
interface ProductFromAPI {
  ...
  lowest_price: number | null; // Sesuai dengan API Anda
  lowest_pic_url: string | null; // Sesuai dengan API Anda
}
...
export default function ProductStorefront({ initialProducts, categories, currentFilters, totalPages, totalItems }: Props) {
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="relative lg:col-span-2">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-transparent focus:bg-white focus:border-[#165dfc] rounded-2xl outline-none transition-all text-sm font-semibold text-slate-700"
            />
          </div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-11 pr-10 py-3.5 bg-slate-50 border border-transparent focus:bg-white focus:border-[#165dfc] rounded-2xl outline-none transition-all text-sm font-semibold text-slate-700 appearance-none cursor-pointer"
            >
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-11 pr-10 py-3.5 bg-slate-50 border border-transparent focus:bg-white focus:border-[#165dfc] rounded-2xl outline-none transition-all text-sm font-bold text-slate-700 appearance-none cursor-pointer uppercase tracking-wider"
            >
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 pt-4 border-t border-slate-50 justify-between">
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <input
              ...
              className="w-full md:w-36 px-4 py-2.5 bg-slate-50 border border-transparent focus:bg-white focus:border-[#165dfc] rounded-xl outline-none transition-all text-xs font-bold text-slate-700"
            />
          ...
          <button
            ...
            disabled={isPending}
            className="w-full md:w-auto bg-[#165dfc] text-white px-8 py-3 rounded-xl font-bold text-xs tracking-widest hover:bg-[#124ecb] transition-all disabled:opacity-50"
          >
      ...
      {/* CUSTOMER SHOP GRID (MENGGUNAKAN SKEMA DATA BARU) */}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2 pt-4">
          ...
          <div className="px-5 py-2 rounded-xl bg-white border border-slate-100 shadow-sm">
            <span className="text-xs font-black text-[#165dfc] tracking-widest">{currentFilters.page} / {totalPages}</span>
          </div>
          <button
            onClick={() => applyFilters({ page: currentFilters.page + 1 })}
