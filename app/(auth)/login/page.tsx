      ...
      <div className="hidden md:flex md:w-5/12 bg-slate-950 p-12 flex-col justify-between relative overflow-hidden text-white select-none">
        ...
        <div className="space-y-6 z-10 max-w-sm my-auto">
          ...
          <h2 className="text-4xl font-black tracking-tight leading-[1.15] text-slate-50">
            Kembali Ke <span className="text-[#165dfc]">Performa</span> Puncakmu.
          </h2>
        ...
        <div className="flex items-center gap-2 text-slate-500 z-10 text-[10px] font-bold uppercase tracking-widest">
          <ShieldCheck className="w-4 h-4 text-[#165dfc]" /> Verified Endpoint Encrypted
        </div>
      </div>
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100/50">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                <div className="w-9 h-5 bg-slate-200 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[#165dfc]"></div>
              </label>
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <Link href="/register" className="text-xs font-black uppercase tracking-widest text-[#165dfc] hover:text-[#124ecb] flex items-center gap-1.5 transition-all hover:gap-2">
