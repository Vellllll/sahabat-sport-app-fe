        ...
        <form action={formAction} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full px-4 py-3 bg-slate-50 border border-transparent focus:bg-white focus:border-[#165dfc] rounded-xl outline-none transition-all font-medium text-slate-700 placeholder:text-slate-300"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select 
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-transparent focus:bg-white focus:border-[#165dfc] rounded-xl outline-none transition-all font-medium text-slate-700 cursor-pointer appearance-none disabled:opacity-50"
              >
                <option value="">
          ...
          <div className="pt-4 space-y-4">
            {state.message && (
              <div className={`text-center py-2 rounded-lg text-[10px] font-bold tracking-widest uppercase animate-in fade-in slide-in-from-top-1 ${state.errors ? 'bg-red-50 text-red-500' : 'bg-blue-50 text-[#165dfc]'}`}>
                {state.message}
              </div>
            )}
            ...
            <button 
              ...
              className="w-full bg-[#165dfc] text-white py-4 rounded-xl font-bold text-sm shadow-lg shadow-[#165dfc]/20 hover:bg-[#124ecb] active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
